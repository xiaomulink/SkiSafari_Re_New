        ...
        //  while (true)
        {
            try
            {
                if (istest == true)
                {
                    ...
                    listerner.Prefixes.Add("http://127.0.0.1:8800/Service/");
                    listerner.Start();
                    listerner.Prefixes.Add("http://127.0.0.1:8800/Service/get/");//添加这个就可以访问任何地方了，就很机车
                }
                else if (istest == false)
                {
                    listerner.AuthenticationSchemes = AuthenticationSchemes.Anonymous;
                    listerner.Prefixes.Add("http://+:8800/Service/");
                    listerner.Start();
                    listerner.Prefixes.Add("http://+:8800/Service/get/");
