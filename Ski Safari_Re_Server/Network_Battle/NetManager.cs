...
internal class NetManager
{
	...
	public static float versionsvalue = 0.1f;

    static TimeController timeController;

    public static void StartLoop(int listenPort,string ip ="0.0.0.0")
	{
        ...
        IPEndPoint localEP = new IPEndPoint(address, 10028);
