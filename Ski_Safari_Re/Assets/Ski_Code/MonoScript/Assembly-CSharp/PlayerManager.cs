...
public class PlayerManager : MonoBehaviour
{
	...
	public static Dictionary<PlayerType, Player> s_players = new Dictionary<PlayerType, Player>();

    public static Dictionary<PlayerType, Attachment> s_attachments = new Dictionary<PlayerType, Attachment>();

    public static List<Player> s_humanPlayers = new List<Player>();
