...
public class Tip : BasePanel
{
	...
	{
		this.text = this.skin.transform.Find("Scroll View/Viewport/Content/TipText").GetComponent<Text>();
		this.CloseButton = this.skin.transform.Find("CloseButton").GetComponent<Button>();
		this.CloseButton.onClick.AddListener(new UnityAction(this.OnOkClick));
		if (args.Length == 1)
		{
